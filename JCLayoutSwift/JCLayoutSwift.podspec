...
Pod::Spec.new do |s|
  ...
  s.author             = { "CharlieYang2018" => "Charlie.Yang@Quest.com" }
  # Or just: s.author    = "CharlieYang2018"
  # s.authors            = { "CharlieYang2018" => "Charlie.Yang@Quest.com" }
  # s.social_media_url   = "http://twitter.com/CharlieYang2018"
  ...
  s.source       = { :git => "https://github.com/CharlieYang2018/JCLayoutSwift", :tag => "#{s.version}" }
